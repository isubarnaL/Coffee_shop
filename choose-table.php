                ...
                <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                  <div class="row">
                      ...
                      <div class="col-lg-3" style="min-height: 190px">
                        <p style="font-weight: bold; padding: ">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Table <?php echo @$i += 1 ?></p><br><br><br><br><br><br>
                        <nav class="menu2">
                      ...
                      <?php } ?>
                      <div class="col-lg-12" style="margin-top: 2%;text-align: center;">
                        <div class="form-group">
                          <select>
                            <option>Click On The Table You Want Above.</option>
                          </select>
                         ...
                         <p style="display:none;text-align: center;"  id="viewMenu"><br>
