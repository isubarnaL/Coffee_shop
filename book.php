	            ...
	            <div class="row d-block flex-row">
	              <h2 class="h4 mb-4">Menu Item Information</h2>
		            <div class="col mb-3 d-flex py-4 border" style="background: white;">
		                	...
		                	<table style="width: 100%">
		                		...
		                		<tbody>
				                    ...
				                    <tr>
						                ...
						                <td><?php echo $qty; ?></td>
			                            <td><?php echo (int)$qty * (int)$itmr['price']; ?></td>
							        </tr>
					                <?php $c++; } } ?>
		                		</tbody>
		                	</table>
	              	...
	              	<div class="col mb-3 d-flex py-4 border" style="background: white;">
		                <div class="align-self-center">
		                  	<p class="mb-0"><span>Total Price:</span> <a href="">Rs.<?php echo $total_price; ?></a></p>
		                </div>
	              	</div>
	        	</div>
          	</div>
<!--             <div class="col-md-12">
          	...
          	<form action="manage-insert.php" method="POST">
                ...
                <div class="form-group">
                  <input type="text" name="transaction_id" class="form-control" placeholder="Special Message/Feedback" required="">
                </div>
