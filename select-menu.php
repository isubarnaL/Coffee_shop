              ...
              <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                <div class="row">
                  <div class="col-lg-12">
					...
					<img style="margin-right: 20px;width: 70px;height: 70px;border-radius: 50%; " src="dashboard/item-image/<?php echo $r['image']; ?>" alt="Item Image" >
					</figure>
                      ...
                      <div class="text d-flex">
                        ...
                        <div class="one-forth" style="text-align: center;">
                          <input type="number" name="qty[]" min="1" placeholder="Quantity" style="width: 120%;margin-left: 23px;margin-top: 18px;padding: 2px;">
                        </div>
                      </div>
                    </div>
                    <?php } ?>
