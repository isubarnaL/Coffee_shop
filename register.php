                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                      ...
                      <form action="manage-insert.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          <input type="text" name="phone" class="form-control" pattern="[9]{1}[0-9]{9}" title="Phone number starts with 9 and has 10 digit" required="" placeholder="Your Phone">
                        </div>
                        <div class="form-group">
                          <textarea name="address" id="" cols="30" rows="2" class="form-control" placeholder="Address"></textarea>
                        </div>
                        <div class="form-group">
                          <input type="password" name="password" class="form-control" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required="" placeholder="Your Password">
                        </div>
                      <!--  <div class="form-group">
